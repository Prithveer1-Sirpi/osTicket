...
return false;">
        ...
        <div class="attached input">
            <input type="text" class="basic-search" placeholder="Search Tickets" data-url="ajax.php/tickets/lookup" name="query"
...
<form action="?" method="POST" name='tickets' id="tickets">
    ...
    <table class="list queue tickets" id="scpTable" border="0" cellspacing="1" cellpadding="2" width="940">
        <thead>
            <tr>
                <?php
    ...
    ?> <div style="padding: 2rem;">
            ...
            <a href="#tickets/export/<?php echo $queue->getId(); ?>"
                id="queue-export" class="no-pjax export"><?php echo __('Export'); ?></a>
